    ...
    private void refreshList() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Teacher = rs.getString("student_id");
...
//column names and values
        ...
        TableColumn<Appointment, String> excelTeacherCol = new TableColumn<Appointment, String>("Teacher");
        excelTeacherCol.setCellValueFactory(new PropertyValueFactory<Appointment, String>("Teacher_treating"));
